...
public class ServerJavaSerialization {
    ...
    public ServerJavaSerialization(String host, int port) {
        this.host = host;
        this.port = port;
    }
    ...
    public static void main(String[] args) {
        final ServerJavaSerialization server = new ServerJavaSerialization("localhost", 9999);
